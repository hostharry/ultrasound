...
def load_model(ckpt_path: str, device: torch.device):
    ...
    window_size = args_dict.get("window_size", 64)
...
if __name__ == "__main__":
    args = build_eval_parser_1d("HASA-FISTA-Swin 1D 评估").parse_args()
    evaluate_1d(load_model, "HASA-FISTA-Swin1D", args)
