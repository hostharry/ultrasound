...
def train(args):
    ...
    exp_name = f"Lite1D_{ds_tag}_{timestamp}"

    run_train_1d(
        args, model,
        model_type="fista_dwt_lite",
        exp_name=exp_name,
        arch_log_lines=[
